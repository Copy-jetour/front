        ...
        <footer className="footer">
            ...
            <div className="container-footer">
                <section className="footer__bottom">
                    ...
                    <a href="https://www.rolf.ru/policy/" className="footer__button" target="_blank" rel="noopener noreferrer">Политика АО «РОЛЬФ» в области обработки и обеспечения безопасности персональных данных</a>
